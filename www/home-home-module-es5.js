  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["home-home-module"], {
    ...
    function srcAppHomeHomePageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var HomePage = /*#__PURE__*/function () {
        function HomePage(mediaCapture, camera) {
        ...
        _createClass(HomePage, [{
          ...
          value: function takePicture() {
            ...
            this.camera.getPicture(options).then(function (imageData) {
              ...
              _this.media_image = "data:image/jpeg;base64," + imageData;
              console.log("Take photo ok:" + _this.media_image);
              _this.story_type = "Image";
              _this.media_video = "";
          ...
          value: function recordVideo() {
            ...
            this.mediaCapture.captureVideo(options).then(function (res) {
              ...
              return console.log('Something went wrong', JSON.stringify(err));
            });
          }
        }]);
